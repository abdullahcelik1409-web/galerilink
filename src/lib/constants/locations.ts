export const TURKEY_LOCATIONS: Record<string, string[]> = {
  ...
  "AĞRI": ["DIYADİN", "DOĞUBAYAZIT", "ELEŞKİRT", "HAMUR", "MERKEZ", "PATNOS", "TAŞLIÇAY", "TUTAK"],
  "AKSARAY": ["AĞAÇÖREN", "ESKİL", "GÜLAĞAÇ", "GÜZELYURT", "MERKEZ", "ORTAKÖY", "SARIYAHŞİ", "SULTANHANI"],
  "AMASYA": ["GÖYNYÜCEK", "GÜMÜŞHACIKÖY", "HAMAMÖZÜ", "MERKEZ", "MERZİFON", "SULUOVA", "TAŞOVA"],
  ...
  "AYDIN": ["BOZDOĞAN", "BUHARKENT", "ÇİNE", "DIDIM", "EFELER", "GERMENCİK", "İNCİRLİOVA", "KARACASU", "KARARPUNAR", "KOÇARLI", "KÖŞK", "KUŞADASI", "KUYUCAK", "NAZİLLİ", "SÖKE", "SULTANHİSAR", "YENİPAZAR"],
  "BALIKESİR": ["ALTIEYLÜL", "AYVALIK", "BALYA", "BANDIRMA", "BİGADİÇ", "BURHANİYE", "DURSUNBEY", "EDREMİT", "ERDEK", "GÖMEÇ", "GÖNEN", "HAVRAN", "İVRİNDİ", "KARESİ", "KEPSUT", "MANYAS", "MARMARA", "SAVAŞTEPE", "SINIRDI", "SUSURLUK"],
  "BARTIN": ["AMASRA", "KURUCAŞİLE", "MERKEZ", "ULUS"],
  "BATMAN": ["BEŞİRİ", "GERCÜŞ", "HASANKEYF", "MERKEZ", "KOZLUK", "SASON"],
  "BAYBURT": ["AYDINTEPE", "DEMİRÖZÜ", "MERKEZ"],
  "BİLECİK": ["BOZÜYÜK", "GÖLPAZARI", "İNHİSAR", "MERKEZ", "OSMANELİ", "PAZARYERİ", "SÖĞÜT", "YENİPAZAR"],
  "BİNGÖL": ["ADAKLI", "GENÇ", "KARLIOVA", "KIĞI", "MERKEZ", "SOLHAN", "YAYLADERE", "YEDİSU"],
  ...
  "ÇORUM": ["ALACA", "BAYAT", "BOĞAZKALE", "İSKİLİP", "KARGI", "LAÇİN", "MECİTÖZÜ", "MERKEZ", "OĞUZLAR", "ORTAKÖY", "OSMANCIK", "SUNGURLU", "UĞURLUDAĞ"],
  ...
  "ESKİŞEHİR": ["ALPU", "BEYLİKOVA", "ÇİFTELER", "GÜNYÜZÜ", "HAN", "İNÖNÜ", "MAHMUDİYE", "MİHALALGI", "MİHALIÇÇIK", "ODUNPAZARI", "SARICAKAYA", "SEYİTGAZİ", "SİVRİHİSAR", "TEPEBAŞI"],
  ...
  "HAKKARİ": ["ÇUKURCA", "DERECEK", "MERKEZ", "ŞEMDİNLİ", "YÜKSEKOVA"],
  "HATAY": ["ALTINÖZÜ", "ANTAKYA", "ARSUZ", "BELEN", "DEFNE", "DÖRTYOL", "ERZİN", "HASSA", "İSKENDERUN", "KIRIKHAN", "KUMLU"],
  ...
  "KASTAMONU": ["ABANA", "AĞLI", "ARAÇ", "AZDAVAY", "BOZKURT", "CİDE", "ÇATALZEYTİN", "DADAY", "DEVREKANİ", "DOĞANYURT", "HANÖNÜ", "İHSANGAZİ", "İNEBOLU", "KÜRE", "MERKEZ", "PINARBAŞI", "ŞENPAZAR", "SEYDİLER", "TAŞKÖPRÜ", "TOSYA"],
  "KAYSERİ": ["AKKIŞLA", "BÜNYAN", "DEVELİ", "FELAHİYE", "HACILAR", "İNCESU", "KOCASİNAN", "MELİKGAZİ", "ÖZVATAN", "PINARBAŞI", "SARIĞLAN", "SARIZ", "TALAS", "TOMARZA", "YAHYALI", "YEŞİLHİSAR"],
  "KİLİS": ["ELBEYLİ", "MERKEZ", "MUSABEYLİ", "POLATELİ"],
  "KIRIKKALE": ["BAHŞILI", "BALIŞEYH", "ÇELEBİ", "DELİCE", "KARAKEÇİLİ", "KESKİN", "MERKEZ", "ÖZİLYA", "YAHŞİHAN"],
  ...
  "KONYA": ["AHIRLI", "AKÖREN", "AKŞEHİR", "ALTINEKİNE", "BEYŞEHİR", "BOZKIR", "CELTIK", "CİHANBEYLİ", "ÇUMRA", "DERBENT", "DEREBUCAK", "DOĞANHİSAR", "EMİRGAZİ", "EREĞLİ", "GÜNEYSINIR", "HADİM", "HALKAPINAR", "HÜYÜK", "ILGIN", "KADINHANI", "KARAPINAR", "KARATAY", "KULU", "MERAM", "SARAYÖNÜ", "SELÇUKLU", "SEYDİŞEHİR", "TAŞKENT", "TUZLUKÇU", "YALIHÜYÜK", "YUNAK"],
  "KÜTAHYA": ["ALTINTAŞ", "ASLANAPA", "ÇAVDARHİSAR", "DOMANİÇ", "DUMLUPINAR", "EMET", "GEDİZ", "HİSARCIK", "MERKEZ", "PAZARLAR", "ŞAPHANE", "SIMAV", "TAVŞANLI"],
  ...
  "MARDİN": ["ARTUKLU", "DARGEÇİT", "DERİK", "KIZILTEPE", "MAZIDAĞI", "MIDYAT", "NUSAYBİN", "ÖMERLİ", "SAVUR", "YEŞİLLİ"],
  "MERSİN": ["AKDENİZ", "ANAMUR", "AYDINCIK", "BOZYAZI", "ÇAMLIYAYLA", "ERDEMLİ", "GÜLNAR", "MEZİTLİ", "MUT", "SILIFKE", "TARSUS", "TOROSLAR", "YENİŞEHİR"],
  ...
  "SİİRT": ["AYDINLAR", "BAYKAN", "ERUH", "KURTALAN", "MERKEZ", "PERVARİ", "ŞİRVAN"],
  ...
  "SİVAS": ["AKINCILAR", "ALTINYAYLA", "DIVRIĞI", "DOĞANŞAR", "GEMEREK", "GÖLOVA", "GÜRÜN", "HAFİK", "İMTRANLI", "KANGAL", "KOYULHİSAR", "MERKEZ", "ŞARKIŞLA", "SUŞEHRİ", "ULAŞ", "YILDIZELİ", "ZARA"],
  "TEKİRDAĞ": ["ÇERKEZKÖY", "ÇORLU", "ERGENE", "HAYRABOLU", "KAPAKLI", "MALKARA", "MARMARAEREĞLİSİ", "MURATLI", "SARAY", "SÜLEYMANPAŞA", "ŞARKÖY"],
  "TOKAT": ["ALMUS", "ARTOVA", "BAŞÇİFTLİK", "ERBAA", "MERKEZ", "NIKZAR", "PAZAR", "REŞADİYE", "SULUSARAY", "TURHAL", "YEŞİLYURT", "ZİLE"],
